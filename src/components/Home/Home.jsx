  ...
  return (
    <div className='custom-scrollbar-container xs:w-screen scrollbar-w-12 scrollbar-thumb-gray-500 scrollbar-thumb-rounded-full scrollbar-track-gray-200 scrollbar-thumb-hover:scrollbar-thumb-gray-700 xs:flex flex-col'>
      <div className='h-[570px]  w-screen overflow-hidden flex flex-col pt-[80px] pl-[160px] xs:pl-4 xs:flex xs:flex-col xs:pt-[30px]'>
        ...
        <div className='xs:w-screen xs:ml-6 xs:mr-3'>
        ...
        <p className='text-sm w-[550px] xs:w-[90%]'>Welcome to THE SOLAR SHOP Energy Equipment & Engg. is promoted by professionals having sound technical qualification and vast experience of more than 20 years. The promoters are also trained in solar energy by Renewable Energy Development Agency and Supreme Solar.</p>
        </div>
      ...
      <div className='xs:flex xs:flex-col'>
        ...
        <div className='flex items-center flex-row mt-[80px] xs:flex xs:items-center xs:justify-center xs:flex-col'>
          <img className='w-[700px] h-[380px] rounded-xl xs:pl-0 pl-[160px] xs:h-[250px] xs:w-[370px]' src={panels} alt="" />
          <div className='h-[300px] xs:ml-0 ml-[100px] bg-gray-500 w-[1.5px] xs:hidden'></div>
          <div className='flex xs:w-[90%] flex-col items-start xs:ml-0 ml-7 gap-6'>
