        ...
        <footer className="bg-white border-y">
            <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0 xs:mb-12">
                        <Link to="/" className="flex items-center">
                            <img
                                src= {logo}
                                className="mr-3 h-16 xs:h-14"
                                alt="Logo"
                            />
                        </Link>
                    </div>
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 xs:ml-5">
                        <div>
                ...
                <hr className="my-6 border-gray-200 sm:mx-auto lg:my-8 xs:ml-5" />
                <div className="sm:flex sm:items-center sm:justify-between xs:ml-5">
                    <span className="text-sm text-gray-500 sm:text-center">
                        © 2023thesolarshop.in. All Rights Reserved.
                    </span>
