...
import img from '../../assets/rooftop.jpg'

const InstInfo = ({info}) => {
  return (
    <div className="relative bg-no-repeat bg-cover rounded-2xl w-[600px] xs:w-[400px] xs:h-[350px] h-[450px] flex pl-[120px] mt-12" style={{backgroundImage:`url(${info.img})`}}>
