...
const Ptypes = ({ info, index, showButton }) => {
  ...
  return (
    <div className='h-auto w-[1270px] pb-10 ml-[120px] mt-16 bg-slate-100 shadow-md rounded-xl flex flex-col justify-between items-start xs:w-[90%] xs:h-auto xs:ml-0 xs:flex xs:items-center xs:justify-center'>
      <div className='flex gap-7 flex-col pl-6 pt-7 xs:pl-4 items-start'>
        ...
        <div className='flex justify-start items-center gap-10 xs:flex-col'>
          ...
          <p className='w-[700px] text-md xs:w-[90%]'>{info.in}</p>
          {info.showButton && (<div className='xs:bg-slate-300 xs:w-[150px] xs:flex xs:pl-0 xs:rounded-full xs:items-center xs:justify-around xs:h-[35px]'>
